...
struct media {
    struct nk_user_font *font_14;
    struct nk_user_font *font_18;
    struct nk_user_font *font_20;
    struct nk_user_font *font_22;
...
grid_demo(struct nk_context *ctx, struct media *media)
{
    ...
    int i;
    nk_style_set_font(ctx, media->font_20);
    if (nk_begin(ctx, "Grid Demo", nk_rect(980, 620, 255, 250),
        NK_WINDOW_TITLE|NK_WINDOW_BORDER|NK_WINDOW_MOVABLE|
        NK_WINDOW_NO_SCROLLBAR))
    {
        nk_style_set_font(ctx, media->font_18);
...
ui_widget(struct nk_context *ctx, struct media *media, float height)
{
    ...
    nk_style_set_font(ctx, media->font_22);
...
button_demo(struct nk_context *ctx, struct media *media)
{
    ...
    nk_style_set_font(ctx, media->font_20);
    nk_begin(ctx, "Button Demo", nk_rect(980,10,255,600),
...
basic_demo(struct nk_context *ctx, struct media *media)
{
    ...
    int i = 0;
    nk_style_set_font(ctx, media->font_20);
    nk_begin(ctx, "Basic Demo", nk_rect(680, 10, 275, 600),
        NK_WINDOW_BORDER|NK_WINDOW_MOVABLE|NK_WINDOW_TITLE);
...
void extendedInit(struct nkc* nkcHandle)
{
    /*struct media media;*/

    /* GUI */
	media.font_14 = nkc_load_font_file(nkcHandle, "data/extra_font/Roboto-Regular.ttf", 14.0f, 0);
    media.font_18 = nkc_load_font_file(nkcHandle, "data/extra_font/Roboto-Regular.ttf", 18.0f, 0); 
    media.font_20 = nkc_load_font_file(nkcHandle, "data/extra_font/Roboto-Regular.ttf", 20.0f, 0); 
	media.font_22 = nkc_load_font_file(nkcHandle, "data/extra_font/Roboto-Regular.ttf", 22.0f, 0);

    /* icons */
    media.unchecked = nkc_load_image_file(nkcHandle, "data/icon/unchecked.png");
    media.checked = nkc_load_image_file(nkcHandle, "data/icon/checked.png");
    media.rocket = nkc_load_image_file(nkcHandle, "data/icon/rocket.png");
    media.cloud = nkc_load_image_file(nkcHandle, "data/icon/cloud.png");
    media.pen = nkc_load_image_file(nkcHandle, "data/icon/pen.png");
    media.play = nkc_load_image_file(nkcHandle, "data/icon/play.png");
    media.pause = nkc_load_image_file(nkcHandle, "data/icon/pause.png");
    media.stop = nkc_load_image_file(nkcHandle, "data/icon/stop.png");
    media.next =  nkc_load_image_file(nkcHandle, "data/icon/next.png");
    media.prev =  nkc_load_image_file(nkcHandle, "data/icon/prev.png");
    media.tools = nkc_load_image_file(nkcHandle, "data/icon/tools.png");
    media.dir = nkc_load_image_file(nkcHandle, "data/icon/directory.png");
    media.copy = nkc_load_image_file(nkcHandle, "data/icon/copy.png");
    media.convert = nkc_load_image_file(nkcHandle, "data/icon/export.png");
    media.del = nkc_load_image_file(nkcHandle, "data/icon/delete.png");
    media.edit = nkc_load_image_file(nkcHandle, "data/icon/edit.png");
    media.menu[0] = nkc_load_image_file(nkcHandle, "data/icon/home.png");
    media.menu[1] = nkc_load_image_file(nkcHandle, "data/icon/phone.png");
    media.menu[2] = nkc_load_image_file(nkcHandle, "data/icon/plane.png");
    media.menu[3] = nkc_load_image_file(nkcHandle, "data/icon/wifi.png");
    media.menu[4] = nkc_load_image_file(nkcHandle, "data/icon/settings.png");
    media.menu[5] = nkc_load_image_file(nkcHandle, "data/icon/volume.png");

    {int i;
    for (i = 0; i < 9; ++i) {
        char buffer[256];
        sprintf(buffer, "data/images/image%d.png", (i+1));
        media.images[i] = nkc_load_image_file(nkcHandle, buffer);
    }}
    ...
    while (!glfwWindowShouldClose(win))
    {
        ...
        /* Draw */
		nkc_render(nkcHandle, nk_rgb(0.3, 0.3, 0.3));
    }
#endif
